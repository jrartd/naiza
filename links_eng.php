	...
	<div class="main row">
		<div class="col-md-4 col-md-offset-4">
			...
			<div class="col-xs-12 zero text-center" style="background: black;color: white;">
				<h1 style="padding: 20px 0px 5px 0px; margin: 0;font-size: 24px;font-weight: 700;">Naiza</h1>
				<p>Choose your music services</p>
			</div>
			<div class="col-xs-12 zero text-center" style="background: white;color: black;">
				<div class="col-xs-12" style="margin: 5px 0px;">
					...
					<div class="col-xs-6">
						<h1 class="col-xs-10 col-xs-offset-1 escuchar">Listen</h1>
					</div>
					</a>
				</div>
				<div class="col-xs-12" style="margin: 5px 0px;">
